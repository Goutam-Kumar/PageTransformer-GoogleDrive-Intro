package com.goutam.pagetransformer.colortransformer;
...
import com.goutam.pagetransformer.R;
...
public class ColortransformActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colortransform);
        ...
        final int color1 = ContextCompat.getColor(this, R.color.intro_1);
        final int color2 = ContextCompat.getColor(this, R.color.intro_2);
        final int color3 = ContextCompat.getColor(this, R.color.intro_3);
        final int color4 = ContextCompat.getColor(this, R.color.intro_4);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        int[] bgs = new int[]{R.drawable.ic_flight_24dp, R.drawable.ic_mail_24dp, R.drawable.ic_explore_24dp,R.drawable.ic_chevron_right_24dp};
